...
| Acesso da automação | Token temporário de sete dias, escopo da equipe `dyllanbr's projects` / All Projects, substituiu o token restrito ao projeto após autorização; expiração exibida: 25/09/2026. Bypass do projeto armazenado, com Require Log In preservado. O run da main validou os acessos de preview e produção. |
